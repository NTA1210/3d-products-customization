...
export const toMm=(value:number,unit:LengthUnit)=>unit==='mm'?value:unit==='cm'?value*10:value*25.4;
export const fromMm=(valueMm:number,unit:LengthUnit)=>unit==='mm'?valueMm:unit==='cm'?valueMm/10:valueMm/25.4;
