...
export type ExportJobData={databaseJobId:string;projectId:string;assetId:string;sourceObjectKey:string;manifest:ModelManifest;configuration:ModelConfiguration;filename:string};
@Injectable()
export class ExportQueueService implements OnModuleDestroy{
  ...
  enqueue(data:ExportJobData){return this.queue.add('bake-glb',data,{jobId:data.databaseJobId});}
